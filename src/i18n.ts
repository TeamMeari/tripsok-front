...
const resources = {
    ko: {
        translation: {
            ...
            enterVerificationCode: "{{email}}으로 보낸 인증코드를 입력해주세요",
            ...
            welcomeNickname: "{{name}}님, 반가워요! 관심있는 여행이 있으신가요?",
            home: "홈으로",
            // ContentPage 텍스트
    ...
    en: {
        translation: {
            ...
            welcomeNickname: "Welcome, {{name}}! Do you have any trips in mind?",
            home: "Go Home",
            // ContentPage 텍스트
    ...
    ja: {
        translation: {
            ...
            enterVerificationCode: "{{email}}に送信された認証コードを入力してください",
            ...
            welcomeNickname: "{{name}}さん、ようこそ！興味のある旅行はありますか？",
            home: "ホームへ",
            // ContentPage 텍스트
    ...
    zh: {
        translation: {
            ...
            enterVerificationCode: "请输入发送到 {{email}} 的验证码",
            expiredCode: "验证码已过期。",
            sixDigitCode: "6位数字",
            noEmail: "没有收到邮件？",
            resend: "重新发送",
            ...
            welcomeNickname: "{{name}}，欢迎！有感兴趣的旅行吗？",
            home: "回到首页",
            // ContentPage 텍스트
