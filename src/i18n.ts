...
const resources = {
    ko: {
        translation: {
            ...
            welcomeNickname: "{{닉네임}}님, 반가워요! 관심있는 여행이 있으신가요?",
            // ContentPage 텍스트
    ...
    en: {
        translation: {
            ...
            emailVerified: "Email verified successfully. Let's continue signing up.",
            ...
            welcomeNickname: "Welcome, {{닉네임}}! Do you have any trips in mind?",
            // ContentPage 텍스트
    ...
    ja: {
        translation: {
            ...
            welcomeNickname: "{{닉네임}}さん、ようこそ！興味のある旅行はありますか？",
            // ContentPage 텍스트
    ...
    zh: {
        translation: {
            ...
            login: "登录",
            logout: "登出",
            loginSlogan: "用 'touang' 更轻松地游江陵",
            passwordRule: "8-20位，必须包含字母、数字和符号",
            resetPassword: "重置密码",
            signup: "注册",
            emailVerification: "邮箱验证",
            emailAddress: "邮箱地址",
            createAccount: "创建一个帐户来保存我的旅程",
            invalidEmail: "邮箱格式无效。",
            existingAccount: "该账号已存在。",
            unregisteredAccount: "账号未注册。",
            passwordMismatch: "两次输入的密码不一致。",
            enterVerificationCode: "请输入发送到 {{이메일}} 的验证码",
            expiredCode: "验证码已过期。",
            sixDigitCode: "6位数字",
            noEmail: "没有收到邮件？",
            resend: "重新发送",
            codeMismatch: "验证码不匹配。",
            emailVerified: "邮箱验证成功。让我们继续注册。",
            ...
            welcomeNickname: "{{닉네임}}，欢迎！有感兴趣的旅行吗？",
            // ContentPage 텍스트
