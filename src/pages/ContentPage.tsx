        ...
        <div className={styles.contentpage}>
            ...
            <div className={styles.Container}>
                <div className={styles.title}>
                    <div className={styles.maintitle}>BTS 버스정류장</div>
                    <div className={styles.subtitle}>청춘 영화의 주인공이 되어보세요</div>
                </div>
                ...
                <div className={styles.ContetntData}>
                    ...
                    <div className={styles.dataDetails}>
                        ...
                        24시 <span className={styles.orangeText}>영업중</span>
                    </div>
                    <div className={styles.dataDetails}>
                ...
                <div className={styles.placePoint}>
                    ...
                    <div className={styles.pointTag}>
                        <HashtagButton label="바다" readOnly/>
                        <HashtagButton label="포토스팟" readOnly/>
                        <HashtagButton label="케이팝" readOnly/>
                        <HashtagButton label="관광지" readOnly/>
                    </div>

                    <div className={styles.pointContent}>
                        BTS 버스 정류장은 강릉 주문진 해변에 위치한 BTS 앨범재킷 촬영장소로 많은 국내외 관광객들이 찾고 있는 핫 플레이스다. K-POP 최초로 미국 빌보드 음반차트 1위를 기록한
                        방탄소년단의 앨범재킷 사진 속에서 등장한 바닷가 버스 정류장이다. 촬영 당시 임시로 만들었다가 철거된 것을 관광객들을 위한 포토존으로 재현해 놓았다. 이미 방탄소년단의 국내외 팬들
                        사이에선 폭발적인 반응을 얻고 있으며, 주문진해변의 이색 볼거리로 떠오르고 있다.
                    </div>
                </div>
